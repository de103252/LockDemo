...
public class SqlPanel extends JPanel {
    ...
    public SqlPanel() {
        ...
        lblNewLabel = new JLabel("Isolation");
        ...
        urlTextField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void removeUpdate(DocumentEvent e) {
                connectButton.setEnabled(e.getDocument().getLength() > 0 || getExecutor().isConnected());
            }
    ...
    private void connectOrDisconnect() {
        if (getExecutor().isConnected()) {
            ...
            getExecutor().setUrl(getUrlTextField().getText());
            getExecutor().connect();
        }
    }
    ...
    private void initControls() {
        if (false) {
            ...
            getUrlTextField().setText(prefs.get("url", "jdbc:derby:derbyDB;create=true"));
        } else {
            getUrlTextField().setText("jdbc:derby:memory:derbyDB;create=true");
        }
    }
    ...
    private void updateControls() {
        ...
        if (isBusy) {
            ...
            getConnectButton().setEnabled(notBlank(getUrlTextField().getText()));
        }
    }
